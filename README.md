...
| [`shopify-axi`](https://github.com/elliottkan/shopify-axi)                                             | elliottkan         | Shopify                            | Search shopify.dev and validate generated GraphQL, Liquid themes, and Polaris components against the real schemas - wraps Shopify's Dev MCP server and exits non-zero on hallucinated fields.                                                                         |
| [`asana-axi`](https://github.com/elliottkan/asana-axi)                                                 | elliottkan         | Project management                 | Create, search, update, and comment on Asana tasks, projects, and portfolios through Asana's official V2 MCP server as a scriptable headless CLI, with OAuth login, TOON output, and structured errors.                                                               |
| [`clockify-axi`](https://github.com/elliottkan/clockify-axi)                                           | elliottkan         | Time tracking                      | Wraps Clockify's full REST API (not just its 13-tool MCP server) with a cached workspace/user identity, TOON output, and AXI exit codes for timers, time entries, projects, tasks, clients, tags, and reports.                                                        |
